 ...
 * Checkout Steps
 */
$GLOBALS['TL_LANG']['MSC']['checkout_login_newuser_guest']	= 'Login';
 ...
 * Miscellaneous
 */
$GLOBALS['TL_LANG']['MSC']['newuserBtnLabel'] = 'Create a new account';
$GLOBALS['TL_LANG']['MSC']['guestBtnLabel'] = 'Continue as a guest';
